...
func (*QueryGetGameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_978c9d8da763e686, []int{0}
}
...
func (*QueryGetGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_978c9d8da763e686, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryGetGameRequest)(nil), "igorsikachyna.checkers.v1.QueryGetGameRequest")
	proto.RegisterType((*QueryGetGameResponse)(nil), "igorsikachyna.checkers.v1.QueryGetGameResponse")
}

func init() {
	proto.RegisterFile("igorsikachyna/checkers/v1/query.proto", fileDescriptor_978c9d8da763e686)
}

var fileDescriptor_978c9d8da763e686 = []byte{
	...
	0x2d, 0x2a, 0xd6, 0x2f, 0x33, 0xd4, 0x2f, 0x2c, 0x4d, 0x2d, 0xaa, 0xd4, 0x2b, 0x28, 0xca, 0x2f,
	...
	0xc4, 0x3d, 0x31, 0x37, 0x35, 0x28, 0xb5, 0xb0, 0x34, 0xb5, 0xb8, 0x44, 0x48, 0x84, 0x8b, 0x35,
	...
	0x1d, 0xf8, 0xe9, 0x89, 0xb9, 0xa9, 0xfa, 0xd5, 0x60, 0xef, 0xd7, 0x3a, 0xd9, 0x9c, 0x78, 0x24,
	...
	0x00, 0xff, 0xff, 0x12, 0x4e, 0x7b, 0xd5, 0x2d, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) GetGame(ctx context.Context, in *QueryGetGameRequest, opts ...grpc.CallOption) (*QueryGetGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/igorsikachyna.checkers.v1.Query/GetGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/igorsikachyna.checkers.v1.Query/GetGame",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "igorsikachyna.checkers.v1.Query",
	...
	Metadata: "igorsikachyna/checkers/v1/query.proto",
}
