...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "checkers.leaderboard.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "checkers.leaderboard.MsgUpdateParamsResponse")
}
...
var fileDescriptor_f66933105b15d7c5 = []byte{
	...
	0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0xcf, 0x4c, 0xcf, 0x2f, 0xd2, 0x2d, 0xce, 0xcc,
	0x4e, 0x4c, 0xce, 0xa8, 0xcc, 0x4b, 0xd4, 0xc7, 0xe1, 0xd5, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24,
	0x36, 0x70, 0x7c, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x69, 0x39, 0x4f, 0xd0, 0x66, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/checkers.leaderboard.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/checkers.leaderboard.Msg/UpdateParams",
	}
